...
export function MatchCard({ match }: { match: Match }) {
  ...
  const matchHref = `/${locale}/match/${match.id}`;
  ...
  return (
    <div
      ...
      className="group relative block flex cursor-pointer flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white p-4 transition-all duration-300 hover:border-blue-500 hover:shadow-lg dark:border-zinc-800 dark:bg-zinc-900 dark:hover:border-blue-400"
    >
      {/* Top Accent Line */}
